...
DbFuntion db = new DbFuntion();
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Ani", 1, 50)); // NOI18N
        ...
        txt2.setFont(new java.awt.Font("Dialog", 0, 16)); // NOI18N
        txt2.setForeground(new java.awt.Color(0, 0, 0));

        txt1.setFont(new java.awt.Font("Dialog", 0, 16)); // NOI18N
        txt1.setForeground(new java.awt.Color(0, 0, 0));

        txt3.setFont(new java.awt.Font("Dialog", 0, 16)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(99, 99, 99)
                        .addComponent(msg, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(139, 139, 139)
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        int phone = Integer.parseInt(txt2.getText());
        String address = txt3.getText();
        try{
        db.insert_data(name, phone, address);
